...
function renderInventoryTable(products) {
  ...
  tbody.innerHTML = products.map(p => `
    <tr>
      <td>
        <img src="${p.image_s3_url || 'static/images/login-hero.jpg'}" alt="${p.product_name}" class="product-thumb" style="width:40px; height:40px; object-fit:cover; border-radius:6px;" onerror="this.src='https://via.placeholder.com/40'"/>
      </td>
